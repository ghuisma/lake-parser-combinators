...
data GenTokenLakeParser a
    = TokenParser
        ...
        identifier  :: LakeParser String -- LakeLakeParser String
        ,
        ...
        symbol      :: String -> LakeParser String --LakeLakeParser String
        ,
